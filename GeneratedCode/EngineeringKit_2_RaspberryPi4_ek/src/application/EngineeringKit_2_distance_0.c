...
#define TASK_NAME "EngineeringKit_2_distance"
#define THIS_TASK_ID (175)
...
#define TASK_INIT void EngineeringKit_2_distance_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_2_distance_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_2_distance_Wrapup0()
