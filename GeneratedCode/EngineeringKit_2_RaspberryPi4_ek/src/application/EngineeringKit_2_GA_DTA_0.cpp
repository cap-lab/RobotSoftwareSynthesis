...
#define TASK_NAME "EngineeringKit_2_GA_DTA"
#define THIS_TASK_ID (178)
...
#define LIBCALL_group(f, ...) l_EngineeringKit_2_grouping_##f(__VA_ARGS__)
#include "EngineeringKit_2_grouping.cicl.h"
#define SYS_REQ(x, ...) SYS_REQ_##x(THIS_TASK_ID, ## __VA_ARGS__)

#define TASK_INIT void EngineeringKit_2_GA_DTA_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_2_GA_DTA_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_2_GA_DTA_Wrapup0()
