...
#define TASK_NAME "EngineeringKit_2_leader"
#define THIS_TASK_ID (179)
...
#define TASK_INIT void EngineeringKit_2_leader_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_2_leader_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_2_leader_Wrapup0()
