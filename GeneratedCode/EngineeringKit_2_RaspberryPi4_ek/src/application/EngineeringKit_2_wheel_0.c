...
#define TASK_NAME "EngineeringKit_2_wheel"
#define THIS_TASK_ID (174)
...
#define TASK_INIT void EngineeringKit_2_wheel_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_2_wheel_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_2_wheel_Wrapup0()
