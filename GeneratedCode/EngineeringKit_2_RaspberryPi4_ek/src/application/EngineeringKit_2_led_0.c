...
#define TASK_NAME "EngineeringKit_2_led"
#define THIS_TASK_ID (177)
...
#define TASK_INIT void EngineeringKit_2_led_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_2_led_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_2_led_Wrapup0()
