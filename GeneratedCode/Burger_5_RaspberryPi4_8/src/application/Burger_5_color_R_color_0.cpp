...
#define TASK_NAME "Burger_5_color_R_color"
#define THIS_TASK_ID (96)
...
#define TASK_INIT void Burger_5_color_R_color_Init0(int TASK_ID)
#define TASK_GO void Burger_5_color_R_color_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_5_color_R_color_Wrapup0()
