...
#define TASK_NAME "Burger_5_leader"
#define THIS_TASK_ID (107)
...
#define TASK_INIT void Burger_5_leader_Init0(int TASK_ID)
#define TASK_GO void Burger_5_leader_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_5_leader_Wrapup0()
