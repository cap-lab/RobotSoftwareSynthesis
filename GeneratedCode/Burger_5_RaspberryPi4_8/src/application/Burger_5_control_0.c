...
#define TASK_NAME "Burger_5_control"
#define THIS_TASK_ID (110)
...
#define TASK_INIT void Burger_5_control_Init0(int TASK_ID)
#define TASK_GO void Burger_5_control_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_5_control_Wrapup0()

#define STATIC static

#include "semo_communication.h"
#include "Burger_5_variable.h"
#include "Burger_5_resource.h"
