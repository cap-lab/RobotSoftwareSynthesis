#ifndef __UEM_LIB_HEADER_BURGER_5_GROUP_ACTION_CICL_H__
#define __UEM_LIB_HEADER_BURGER_5_GROUP_ACTION_CICL_H__
...
#define LIBFUNC(rtype, f, ...) rtype l_Burger_5_group_action_##f(__VA_ARGS__)
...
#endif /* __UEM_LIB_HEADER_BURGER_5_GROUP_ACTION_CICL_H__ */
