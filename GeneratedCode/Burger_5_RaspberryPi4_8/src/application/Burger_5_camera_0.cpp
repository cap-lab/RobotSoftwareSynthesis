...
#define TASK_NAME "Burger_5_camera"
#define THIS_TASK_ID (102)
...
#define TASK_INIT void Burger_5_camera_Init0(int TASK_ID)
#define TASK_GO void Burger_5_camera_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_5_camera_Wrapup0()
