...
#define MULTICAST_Burger_5_camera_SIZE (691200)
#define MULTICAST_Robot_groupB_leader_heartbeat_SIZE (16)
#define MULTICAST_Robot_groupA_leader_robotId_SIZE (16)
#define MULTICAST_Burger_5_color_SIZE (4)
#define MULTICAST_Burger_5_wheel_SIZE (4)
#define MULTICAST_Robot_leader_robotId_SIZE (16)
#define MULTICAST_Burger_5_distance_SIZE (16)
...
#define MULTICAST_Burger_5_led_SIZE (8)
...
char s_pMulticastGroup_Burger_5_camera_buffer[MULTICAST_Burger_5_camera_SIZE];
...
char s_pMulticastGroup_Burger_5_color_buffer[MULTICAST_Burger_5_color_SIZE];
char s_pMulticastGroup_Burger_5_wheel_buffer[MULTICAST_Burger_5_wheel_SIZE];
char s_pMulticastGroup_Robot_leader_robotId_buffer[MULTICAST_Robot_leader_robotId_SIZE];
char s_pMulticastGroup_Burger_5_distance_buffer[MULTICAST_Burger_5_distance_SIZE];
...
char s_pMulticastGroup_Burger_5_led_buffer[MULTICAST_Burger_5_led_SIZE];
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_5_camera = {
	s_pMulticastGroup_Burger_5_camera_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_5_color = {
	s_pMulticastGroup_Burger_5_color_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_5_wheel = {
	s_pMulticastGroup_Burger_5_wheel_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_5_distance = {
	s_pMulticastGroup_Burger_5_distance_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_5_led = {
	s_pMulticastGroup_Burger_5_led_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_5_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_camera,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_5_camera[] = {
	{
		88, // nTaskId
		0, // nPortId
		"camera", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_5_camera, // astCommunicationList
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_5_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_color,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_5_color[] = {
	{
		87, // nTaskId
		0, // nPortId
		"color", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_5_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		91, // nTaskId
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_5_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_wheel,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_5_wheel[] = {
	{
		98, // nTaskId
		0, // nPortId
		"wheel", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_5_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_5_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_distance,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_5_distance[] = {
	{
		87, // nTaskId
		0, // nPortId
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_5_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		91, // nTaskId
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_5_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_led,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_5_led[] = {
	{
		103, // nTaskId
		0, // nPortId
		"led", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_5_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_5_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_camera,
...
SMulticastPort g_astMulticastOutputPortList_Burger_5_camera[] = {
	{
		102, // nTaskId
		2, // nMulticastPortId
		"camera", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_5_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_5_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_color,
...
SMulticastPort g_astMulticastOutputPortList_Burger_5_color[] = {
	{
		96, // nTaskId
		2, // nMulticastPortId
		"color", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_5_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_5_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_wheel,
...
SMulticastPort g_astMulticastOutputPortList_Burger_5_wheel[] = {
	{
		91, // nTaskId
		1, // nMulticastPortId
		"wheel", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_5_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		84, // nTaskId
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_5_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_distance,
...
SMulticastPort g_astMulticastOutputPortList_Burger_5_distance[] = {
	{
		101, // nTaskId
		2, // nMulticastPortId
		"distance", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_5_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_5_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_led,
...
SMulticastPort g_astMulticastOutputPortList_Burger_5_led[] = {
	{
		93, // nTaskId
		1, // nMulticastPortId
		"led", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_5_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		89, // nTaskId
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_5_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_camera,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_5_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_color,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_5_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_wheel,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_5_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_distance,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_5_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_5_led,
...
SMulticastGroup g_astMulticastGroups[] = {
	...
	{
		32, // Multicast group ID
		"Burger_5_camera", // pszGroupName
		MULTICAST_Burger_5_camera_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_5_camera, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_Burger_5_camera, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_5_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		29, // Multicast group ID
		"Burger_5_color", // pszGroupName
		MULTICAST_Burger_5_color_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_5_color, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_Burger_5_color, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_5_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		30, // Multicast group ID
		"Burger_5_wheel", // pszGroupName
		MULTICAST_Burger_5_wheel_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_5_wheel, // pstInputPort
		1, // nInputPortNum
		g_astMulticastOutputPortList_Burger_5_wheel, // pstOutputPort
		3, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_5_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		31, // Multicast group ID
		"Burger_5_distance", // pszGroupName
		MULTICAST_Burger_5_distance_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_5_distance, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_Burger_5_distance, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_5_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		33, // Multicast group ID
		"Burger_5_led", // pszGroupName
		MULTICAST_Burger_5_led_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_5_led, // pstInputPort
		1, // nInputPortNum
		g_astMulticastOutputPortList_Burger_5_led, // pstOutputPort
		2, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_5_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
