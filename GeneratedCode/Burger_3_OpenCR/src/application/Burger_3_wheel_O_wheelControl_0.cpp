...
#define TASK_NAME "Burger_3_wheel_O_wheelControl"
#define THIS_TASK_ID (71)
...
#define TASK_INIT void Burger_3_wheel_O_wheelControl_Init0(int TASK_ID)
#define TASK_GO void Burger_3_wheel_O_wheelControl_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_3_wheel_O_wheelControl_Wrapup0()
