...
#define TASK_NAME "Burger_1_distance"
#define THIS_TASK_ID (17)
...
#define TASK_INIT void Burger_1_distance_Init0(int TASK_ID)
#define TASK_GO void Burger_1_distance_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_1_distance_Wrapup0()
