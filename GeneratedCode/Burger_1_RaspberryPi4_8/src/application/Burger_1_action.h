#ifndef __Burger_1_ACTION_HEADER__
#define __Burger_1_ACTION_HEADER__
...
typedef enum _ACTION_TASK_ID {
    ID_ACTION_TASK_Burger_1_Robot_REMOTE_CONTROL_RemoteControl_Burger_remoteControl,
    ID_ACTION_TASK_Burger_1_Robot_REMOTE_CONTROL_ReceiveCommandFromOperator_Burger_getModeTransferCommand,
    ID_ACTION_TASK_Burger_1_Robot_SEARCH_GROUPING_ReceiveCommandFromOperator_Burger_getModeTransferCommand,
    ID_ACTION_TASK_Burger_1_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3,
    ID_ACTION_TASK_Burger_1_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3,
} ACTION_TASK_ID;
