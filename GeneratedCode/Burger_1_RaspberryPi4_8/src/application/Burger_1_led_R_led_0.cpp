...
#define TASK_NAME "Burger_1_led_R_led"
#define THIS_TASK_ID (19)
...
#define TASK_INIT void Burger_1_led_R_led_Init0(int TASK_ID)
#define TASK_GO void Burger_1_led_R_led_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_1_led_R_led_Wrapup0()
