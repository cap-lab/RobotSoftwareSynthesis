#ifndef __UEM_LIB_HEADER_BURGER_1_LEADER_LIB_CICL_H__
#define __UEM_LIB_HEADER_BURGER_1_LEADER_LIB_CICL_H__
...
#endif /* __UEM_LIB_HEADER_BURGER_1_LEADER_LIB_CICL_H__ */
