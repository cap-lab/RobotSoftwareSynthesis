...
#define TASK_NAME "Burger_1_camera"
#define THIS_TASK_ID (18)
...
#define TASK_INIT void Burger_1_camera_Init0(int TASK_ID)
#define TASK_GO void Burger_1_camera_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_1_camera_Wrapup0()
