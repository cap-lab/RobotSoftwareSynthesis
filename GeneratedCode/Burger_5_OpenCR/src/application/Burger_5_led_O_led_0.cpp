...
#define TASK_NAME "Burger_5_led_O_led"
#define THIS_TASK_ID (104)
...
#define TASK_INIT void Burger_5_led_O_led_Init0(int TASK_ID)
#define TASK_GO void Burger_5_led_O_led_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_5_led_O_led_Wrapup0()
