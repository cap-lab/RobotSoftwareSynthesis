...
#define TASK_NAME "Burger_5_wheel_O_wheelControl"
#define THIS_TASK_ID (99)
...
#define TASK_INIT void Burger_5_wheel_O_wheelControl_Init0(int TASK_ID)
#define TASK_GO void Burger_5_wheel_O_wheelControl_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_5_wheel_O_wheelControl_Wrapup0()
