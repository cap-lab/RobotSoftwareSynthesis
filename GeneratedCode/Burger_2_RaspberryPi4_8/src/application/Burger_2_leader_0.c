...
#define TASK_NAME "Burger_2_leader"
#define THIS_TASK_ID (51)
...
#define TASK_INIT void Burger_2_leader_Init0(int TASK_ID)
#define TASK_GO void Burger_2_leader_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_2_leader_Wrapup0()
