...
#define TASK_NAME "Burger_2_control"
#define THIS_TASK_ID (54)
...
#define TASK_INIT void Burger_2_control_Init0(int TASK_ID)
#define TASK_GO void Burger_2_control_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_2_control_Wrapup0()
