...
#define TASK_NAME "Burger_2_distance"
#define THIS_TASK_ID (45)
...
#define TASK_INIT void Burger_2_distance_Init0(int TASK_ID)
#define TASK_GO void Burger_2_distance_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_2_distance_Wrapup0()
