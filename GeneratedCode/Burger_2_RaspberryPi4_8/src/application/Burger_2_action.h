#ifndef __Burger_2_ACTION_HEADER__
#define __Burger_2_ACTION_HEADER__

#include "semo_common.h"
#include "semo_port.h"
#include "Burger_2_resource.h"

typedef enum _ACTION_TASK_ID {
    ID_ACTION_TASK_Burger_2_Robot_REMOTE_CONTROL_RemoteControl_Burger_remoteControl,
    ID_ACTION_TASK_Burger_2_Robot_REMOTE_CONTROL_ReceiveCommandFromOperator_Burger_getModeTransferCommand,
    ID_ACTION_TASK_Burger_2_Robot_SEARCH_GROUPING_ReceiveCommandFromOperator_Burger_getModeTransferCommand,
    ID_ACTION_TASK_Burger_2_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3,
    ID_ACTION_TASK_Burger_2_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3,
} ACTION_TASK_ID;
