...
#define TASK_NAME "Burger_2_listen"
#define THIS_TASK_ID (52)
...
#define TASK_INIT void Burger_2_listen_Init0(int TASK_ID)
#define TASK_GO void Burger_2_listen_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_2_listen_Wrapup0()
