...
#define TASK_NAME "Burger_2_camera"
#define THIS_TASK_ID (46)
...
#define TASK_INIT void Burger_2_camera_Init0(int TASK_ID)
#define TASK_GO void Burger_2_camera_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_2_camera_Wrapup0()
