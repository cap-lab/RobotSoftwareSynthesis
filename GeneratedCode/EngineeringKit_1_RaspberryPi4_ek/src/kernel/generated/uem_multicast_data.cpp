...
#define MULTICAST_EngineeringKit_1_distance_SIZE (16)
#define MULTICAST_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3_SIZE (16)
#define MULTICAST_EngineeringKit_1_wheel_SIZE (4)
#define MULTICAST_EngineeringKit_1_camera_SIZE (691200)
#define MULTICAST_Robot_groupB_leader_heartbeat_SIZE (16)
#define MULTICAST_EngineeringKit_1_color_SIZE (4)
#define MULTICAST_Robot_groupA_leader_robotId_SIZE (16)
#define MULTICAST_EngineeringKit_1_led_SIZE (8)
...
char s_pMulticastGroup_EngineeringKit_1_distance_buffer[MULTICAST_EngineeringKit_1_distance_SIZE];
...
char s_pMulticastGroup_EngineeringKit_1_wheel_buffer[MULTICAST_EngineeringKit_1_wheel_SIZE];
char s_pMulticastGroup_EngineeringKit_1_camera_buffer[MULTICAST_EngineeringKit_1_camera_SIZE];
char s_pMulticastGroup_Robot_groupB_leader_heartbeat_buffer[MULTICAST_Robot_groupB_leader_heartbeat_SIZE];
char s_pMulticastGroup_EngineeringKit_1_color_buffer[MULTICAST_EngineeringKit_1_color_SIZE];
char s_pMulticastGroup_Robot_groupA_leader_robotId_buffer[MULTICAST_Robot_groupA_leader_robotId_SIZE];
char s_pMulticastGroup_EngineeringKit_1_led_buffer[MULTICAST_EngineeringKit_1_led_SIZE];
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_EngineeringKit_1_distance = {
	s_pMulticastGroup_EngineeringKit_1_distance_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_EngineeringKit_1_wheel = {
	s_pMulticastGroup_EngineeringKit_1_wheel_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
SSharedMemoryMulticast g_stSharedMemoryMulticast_EngineeringKit_1_camera = {
	s_pMulticastGroup_EngineeringKit_1_camera_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_EngineeringKit_1_color = {
	s_pMulticastGroup_EngineeringKit_1_color_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_EngineeringKit_1_led = {
	s_pMulticastGroup_EngineeringKit_1_led_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SMulticastCommunication g_astMulticastInputCommunicationList_EngineeringKit_1_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_distance,
	},
};

SMulticastPort g_astMulticastInputPortList_EngineeringKit_1_distance[] = {
	{
		147, // nTaskId
		0, // nPortId
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_EngineeringKit_1_distance, // astCommunicationList
...
SMulticastCommunication g_astMulticastInputCommunicationList_EngineeringKit_1_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_wheel,
	},
};

SMulticastPort g_astMulticastInputPortList_EngineeringKit_1_wheel[] = {
	{
		151, // nTaskId
		0, // nPortId
		"wheel", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_EngineeringKit_1_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
SMulticastCommunication g_astMulticastInputCommunicationList_EngineeringKit_1_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_camera,
	},
};

SMulticastPort g_astMulticastInputPortList_EngineeringKit_1_camera[] = {
	{
		148, // nTaskId
		0, // nPortId
		"camera", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_EngineeringKit_1_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		144, // nTaskId
...
SMulticastCommunication g_astMulticastInputCommunicationList_EngineeringKit_1_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_color,
	},
};

SMulticastPort g_astMulticastInputPortList_EngineeringKit_1_color[] = {
	{
		143, // nTaskId
		0, // nPortId
		"color", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_EngineeringKit_1_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		147, // nTaskId
...
SMulticastCommunication g_astMulticastInputCommunicationList_EngineeringKit_1_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_led,
	},
};

SMulticastPort g_astMulticastInputPortList_EngineeringKit_1_led[] = {
	{
		155, // nTaskId
		0, // nPortId
		"led", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_EngineeringKit_1_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_EngineeringKit_1_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_distance,
...
SMulticastPort g_astMulticastOutputPortList_EngineeringKit_1_distance[] = {
	{
		153, // nTaskId
		2, // nMulticastPortId
		"distance", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_EngineeringKit_1_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_EngineeringKit_1_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_wheel,
...
SMulticastPort g_astMulticastOutputPortList_EngineeringKit_1_wheel[] = {
	{
		143, // nTaskId
		1, // nMulticastPortId
		"wheel", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_EngineeringKit_1_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		147, // nTaskId
...
SMulticastCommunication g_astMulticastOutputCommunicationList_EngineeringKit_1_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_camera,
...
SMulticastPort g_astMulticastOutputPortList_EngineeringKit_1_camera[] = {
	{
		154, // nTaskId
		2, // nMulticastPortId
		"camera", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_EngineeringKit_1_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_EngineeringKit_1_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_color,
...
SMulticastPort g_astMulticastOutputPortList_EngineeringKit_1_color[] = {
	{
		152, // nTaskId
		2, // nMulticastPortId
		"color", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_EngineeringKit_1_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_EngineeringKit_1_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_led,
...
SMulticastPort g_astMulticastOutputPortList_EngineeringKit_1_led[] = {
	{
		145, // nTaskId
		1, // nMulticastPortId
		"led", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_EngineeringKit_1_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		149, // nTaskId
...
SMulticastCommunication g_astMulticastCommunicationList_EngineeringKit_1_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_distance,
...
SMulticastCommunication g_astMulticastCommunicationList_EngineeringKit_1_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_wheel,
...
SMulticastCommunication g_astMulticastCommunicationList_EngineeringKit_1_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_camera,
...
SMulticastCommunication g_astMulticastCommunicationList_EngineeringKit_1_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_color,
...
SMulticastCommunication g_astMulticastCommunicationList_EngineeringKit_1_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_EngineeringKit_1_led,
...
SMulticastGroup g_astMulticastGroups[] = {
	...
	{
		41, // Multicast group ID
		"EngineeringKit_1_distance", // pszGroupName
		MULTICAST_EngineeringKit_1_distance_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_EngineeringKit_1_distance, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_EngineeringKit_1_distance, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_EngineeringKit_1_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		39, // Multicast group ID
		"EngineeringKit_1_wheel", // pszGroupName
		MULTICAST_EngineeringKit_1_wheel_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_EngineeringKit_1_wheel, // pstInputPort
		1, // nInputPortNum
		g_astMulticastOutputPortList_EngineeringKit_1_wheel, // pstOutputPort
		3, // nOutputPortNum
		g_astMulticastCommunicationList_EngineeringKit_1_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		42, // Multicast group ID
		"EngineeringKit_1_camera", // pszGroupName
		MULTICAST_EngineeringKit_1_camera_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_EngineeringKit_1_camera, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_EngineeringKit_1_camera, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_EngineeringKit_1_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		40, // Multicast group ID
		"EngineeringKit_1_color", // pszGroupName
		MULTICAST_EngineeringKit_1_color_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_EngineeringKit_1_color, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_EngineeringKit_1_color, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_EngineeringKit_1_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		43, // Multicast group ID
		"EngineeringKit_1_led", // pszGroupName
		MULTICAST_EngineeringKit_1_led_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_EngineeringKit_1_led, // pstInputPort
		1, // nInputPortNum
		g_astMulticastOutputPortList_EngineeringKit_1_led, // pstOutputPort
		2, // nOutputPortNum
		g_astMulticastCommunicationList_EngineeringKit_1_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
