#ifndef __UEM_LIB_HEADER_ENGINEERINGKIT_1_GROUP_ACTION_CICL_H__
#define __UEM_LIB_HEADER_ENGINEERINGKIT_1_GROUP_ACTION_CICL_H__
...
#define LIBFUNC(rtype, f, ...) rtype l_EngineeringKit_1_group_action_##f(__VA_ARGS__)
...
#endif /* __UEM_LIB_HEADER_ENGINEERINGKIT_1_GROUP_ACTION_CICL_H__ */
