...
ACTION_TASK action_task_list[5] = {
    {ID_ACTION_TASK_EngineeringKit_1_Robot_REMOTE_CONTROL_RemoteControl_EngineeringKit_remoteControl, // ACTION_TASK_ID action_task_id
     ID_ACTION_TYPE_remoteControl, // ACTION_TYPE_ID action_type_id
     0, // semo_int32 task_id
     "Robot_REMOTE_CONTROL_RemoteControl_EngineeringKit_remoteControl", // char *task_name
     ...
     5, // semo_int32 group_action_id,
     NULL}, // PORT *group_port
    {ID_ACTION_TASK_EngineeringKit_1_Robot_REMOTE_CONTROL_ReceiveCommandFromOperator_EngineeringKit_getModeTransferCommand, // ACTION_TASK_ID action_task_id
     ID_ACTION_TYPE_getModeTransferCommand, // ACTION_TYPE_ID action_type_id
     1, // semo_int32 task_id
     "Robot_REMOTE_CONTROL_ReceiveCommandFromOperator_EngineeringKit_getModeTransferCommand", // char *task_name
     SEMO_RUN, // SEMO_STATE state
     FALSE, // semo_int8 return_immediate
     0, // semo_int32 resource_list_size 
     NULL, // RESOURCE_ID *resource_list
     ...
     output_port_of_EngineeringKit_1_Robot_REMOTE_CONTROL_ReceiveCommandFromOperator_EngineeringKit_getModeTransferCommand, // PORT *output_port_list
     FALSE, // semo_int8 is_group_action,
     6, // semo_int32 group_action_id,
     NULL}, // PORT *group_port
    {ID_ACTION_TASK_EngineeringKit_1_Robot_SEARCH_GROUPING_ReceiveCommandFromOperator_EngineeringKit_getModeTransferCommand, // ACTION_TASK_ID action_task_id
     ID_ACTION_TYPE_getModeTransferCommand, // ACTION_TYPE_ID action_type_id
     2, // semo_int32 task_id
     "Robot_SEARCH_GROUPING_ReceiveCommandFromOperator_EngineeringKit_getModeTransferCommand", // char *task_name
     SEMO_RUN, // SEMO_STATE state
     FALSE, // semo_int8 return_immediate
     0, // semo_int32 resource_list_size 
     NULL, // RESOURCE_ID *resource_list
     ...
     NULL, // PORT *input_port_list
     1, // semo_int32 output_list_size
     output_port_of_EngineeringKit_1_Robot_SEARCH_GROUPING_ReceiveCommandFromOperator_EngineeringKit_getModeTransferCommand, // PORT *output_port_list
     FALSE, // semo_int8 is_group_action,
     7, // semo_int32 group_action_id,
     NULL}, // PORT *group_port
    {ID_ACTION_TASK_EngineeringKit_1_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3, // ACTION_TASK_ID action_task_id
     ID_ACTION_TYPE_searchV3, // ACTION_TYPE_ID action_type_id
     171, // semo_int32 task_id
     "Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3", // char *task_name
     SEMO_RUN, // SEMO_STATE state
     FALSE, // semo_int8 return_immediate
     0, // semo_int32 resource_list_size 
     NULL, // RESOURCE_ID *resource_list
     3, // semo_int32 input_list_size
     input_port_of_EngineeringKit_1_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3, // PORT *input_port_list
     1, // semo_int32 output_list_size
     output_port_of_EngineeringKit_1_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3, // PORT *output_port_list
     TRUE, // semo_int8 is_group_action,
     8, // semo_int32 group_action_id,
     &group_port_of_EngineeringKit_1_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3}, // PORT *group_port
    {ID_ACTION_TASK_EngineeringKit_1_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3, // ACTION_TASK_ID action_task_id
     ID_ACTION_TYPE_searchV3, // ACTION_TYPE_ID action_type_id
     175, // semo_int32 task_id
     "Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3", // char *task_name
     SEMO_RUN, // SEMO_STATE state
     FALSE, // semo_int8 return_immediate
     0, // semo_int32 resource_list_size 
     NULL, // RESOURCE_ID *resource_list
     3, // semo_int32 input_list_size
     input_port_of_EngineeringKit_1_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3, // PORT *input_port_list
     1, // semo_int32 output_list_size
     output_port_of_EngineeringKit_1_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3, // PORT *output_port_list
     TRUE, // semo_int8 is_group_action,
     9, // semo_int32 group_action_id,
     &group_port_of_EngineeringKit_1_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_EngineeringKit_searchV3}, // PORT *group_port
};
