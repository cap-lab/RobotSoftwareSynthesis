...
#define TASK_NAME "EngineeringKit_1_distance"
#define THIS_TASK_ID (153)
...
#define TASK_INIT void EngineeringKit_1_distance_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_1_distance_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_1_distance_Wrapup0()
