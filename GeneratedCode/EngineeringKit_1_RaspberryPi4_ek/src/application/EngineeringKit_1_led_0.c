...
#define TASK_NAME "EngineeringKit_1_led"
#define THIS_TASK_ID (155)
...
#define TASK_INIT void EngineeringKit_1_led_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_1_led_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_1_led_Wrapup0()
