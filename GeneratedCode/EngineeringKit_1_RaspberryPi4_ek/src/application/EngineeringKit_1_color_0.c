...
#define TASK_NAME "EngineeringKit_1_color"
#define THIS_TASK_ID (152)
...
#define TASK_INIT void EngineeringKit_1_color_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_1_color_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_1_color_Wrapup0()
