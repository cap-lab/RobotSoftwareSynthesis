...
#define TASK_NAME "EngineeringKit_1_wheel"
#define THIS_TASK_ID (151)
...
#define TASK_INIT void EngineeringKit_1_wheel_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_1_wheel_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_1_wheel_Wrapup0()
