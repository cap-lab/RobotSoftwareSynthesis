...
#define TASK_NAME "EngineeringKit_1_camera"
#define THIS_TASK_ID (154)
...
#define TASK_INIT void EngineeringKit_1_camera_Init0(int TASK_ID)
#define TASK_GO void EngineeringKit_1_camera_Go0(int nTaskId)
#define TASK_WRAPUP void EngineeringKit_1_camera_Wrapup0()
