...
ACTION_TASK action_task_list[5] = {
    {ID_ACTION_TASK_Burger_3_Robot_REMOTE_CONTROL_RemoteControl_Burger_remoteControl, // ACTION_TASK_ID action_task_id
    ...
    {ID_ACTION_TASK_Burger_3_Robot_REMOTE_CONTROL_ReceiveCommandFromOperator_Burger_getModeTransferCommand, // ACTION_TASK_ID action_task_id
     ...
     output_port_of_Burger_3_Robot_REMOTE_CONTROL_ReceiveCommandFromOperator_Burger_getModeTransferCommand, // PORT *output_port_list
     FALSE, // semo_int8 is_group_action,
     1, // semo_int32 group_action_id,
     NULL}, // PORT *group_port
    {ID_ACTION_TASK_Burger_3_Robot_SEARCH_GROUPING_ReceiveCommandFromOperator_Burger_getModeTransferCommand, // ACTION_TASK_ID action_task_id
     ID_ACTION_TYPE_getModeTransferCommand, // ACTION_TYPE_ID action_type_id
     ...
     NULL, // PORT *input_port_list
     1, // semo_int32 output_list_size
     output_port_of_Burger_3_Robot_SEARCH_GROUPING_ReceiveCommandFromOperator_Burger_getModeTransferCommand, // PORT *output_port_list
     FALSE, // semo_int8 is_group_action,
     2, // semo_int32 group_action_id,
     NULL}, // PORT *group_port
    {ID_ACTION_TASK_Burger_3_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3, // ACTION_TASK_ID action_task_id
     ID_ACTION_TYPE_searchV3, // ACTION_TYPE_ID action_type_id
     72, // semo_int32 task_id
     ...
     input_port_of_Burger_3_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3, // PORT *input_port_list
     1, // semo_int32 output_list_size
     output_port_of_Burger_3_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3, // PORT *output_port_list
     TRUE, // semo_int8 is_group_action,
     3, // semo_int32 group_action_id,
     &group_port_of_Burger_3_Robot_groupA_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3}, // PORT *group_port
    {ID_ACTION_TASK_Burger_3_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3, // ACTION_TASK_ID action_task_id
     ID_ACTION_TYPE_searchV3, // ACTION_TYPE_ID action_type_id
     76, // semo_int32 task_id
     ...
     NULL, // RESOURCE_ID *resource_list
     3, // semo_int32 input_list_size
     input_port_of_Burger_3_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3, // PORT *input_port_list
     1, // semo_int32 output_list_size
     output_port_of_Burger_3_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3, // PORT *output_port_list
     TRUE, // semo_int8 is_group_action,
     4, // semo_int32 group_action_id,
     &group_port_of_Burger_3_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3}, // PORT *group_port
};
