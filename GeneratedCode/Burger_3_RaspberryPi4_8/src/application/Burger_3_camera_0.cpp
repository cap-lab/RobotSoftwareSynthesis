...
#define TASK_NAME "Burger_3_camera"
#define THIS_TASK_ID (74)
...
#define TASK_INIT void Burger_3_camera_Init0(int TASK_ID)
#define TASK_GO void Burger_3_camera_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_3_camera_Wrapup0()
