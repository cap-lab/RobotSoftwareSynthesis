...
#define TASK_NAME "Burger_3_distance"
#define THIS_TASK_ID (73)
...
#define TASK_INIT void Burger_3_distance_Init0(int TASK_ID)
#define TASK_GO void Burger_3_distance_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_3_distance_Wrapup0()
