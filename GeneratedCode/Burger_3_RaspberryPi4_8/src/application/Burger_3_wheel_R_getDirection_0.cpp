...
#define TASK_NAME "Burger_3_wheel_R_getDirection"
#define THIS_TASK_ID (70)
...
#define TASK_INIT void Burger_3_wheel_R_getDirection_Init0(int TASK_ID)
#define TASK_GO void Burger_3_wheel_R_getDirection_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_3_wheel_R_getDirection_Wrapup0()
