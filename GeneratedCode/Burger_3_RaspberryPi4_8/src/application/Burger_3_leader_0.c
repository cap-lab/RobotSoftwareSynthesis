...
#define TASK_NAME "Burger_3_leader"
#define THIS_TASK_ID (79)
...
#define TASK_INIT void Burger_3_leader_Init0(int TASK_ID)
#define TASK_GO void Burger_3_leader_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_3_leader_Wrapup0()
