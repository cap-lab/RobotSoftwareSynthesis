...
#define MULTICAST_Burger_3_distance_SIZE (16)
#define MULTICAST_Burger_3_camera_SIZE (691200)
...
#define MULTICAST_Burger_3_wheel_SIZE (4)
#define MULTICAST_Burger_3_led_SIZE (8)
...
#define MULTICAST_Burger_3_color_SIZE (4)
...
char s_pMulticastGroup_Burger_3_distance_buffer[MULTICAST_Burger_3_distance_SIZE];
char s_pMulticastGroup_Burger_3_camera_buffer[MULTICAST_Burger_3_camera_SIZE];
...
char s_pMulticastGroup_Burger_3_wheel_buffer[MULTICAST_Burger_3_wheel_SIZE];
char s_pMulticastGroup_Burger_3_led_buffer[MULTICAST_Burger_3_led_SIZE];
...
char s_pMulticastGroup_Burger_3_color_buffer[MULTICAST_Burger_3_color_SIZE];
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_3_distance = {
	s_pMulticastGroup_Burger_3_distance_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_3_camera = {
	s_pMulticastGroup_Burger_3_camera_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_3_wheel = {
	s_pMulticastGroup_Burger_3_wheel_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_3_led = {
	s_pMulticastGroup_Burger_3_led_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_3_color = {
	s_pMulticastGroup_Burger_3_color_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_3_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_distance,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_3_distance[] = {
	{
		63, // nTaskId
		0, // nPortId
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_3_distance, // astCommunicationList
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_3_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_camera,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_3_camera[] = {
	{
		64, // nTaskId
		0, // nPortId
		"camera", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_3_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		60, // nTaskId
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_3_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_wheel,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_3_wheel[] = {
	{
		70, // nTaskId
		0, // nPortId
		"wheel", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_3_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_3_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_led,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_3_led[] = {
	{
		75, // nTaskId
		0, // nPortId
		"led", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_3_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_3_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_color,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_3_color[] = {
	{
		63, // nTaskId
		0, // nPortId
		"color", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_3_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		59, // nTaskId
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_3_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_distance,
...
SMulticastPort g_astMulticastOutputPortList_Burger_3_distance[] = {
	{
		73, // nTaskId
		2, // nMulticastPortId
		"distance", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_3_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_3_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_camera,
...
SMulticastPort g_astMulticastOutputPortList_Burger_3_camera[] = {
	{
		74, // nTaskId
		2, // nMulticastPortId
		"camera", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_3_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_3_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_wheel,
...
SMulticastPort g_astMulticastOutputPortList_Burger_3_wheel[] = {
	{
		56, // nTaskId
		1, // nMulticastPortId
		"wheel", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_3_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		59, // nTaskId
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_3_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_led,
...
SMulticastPort g_astMulticastOutputPortList_Burger_3_led[] = {
	{
		61, // nTaskId
		1, // nMulticastPortId
		"led", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_3_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		65, // nTaskId
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_3_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_color,
...
SMulticastPort g_astMulticastOutputPortList_Burger_3_color[] = {
	{
		68, // nTaskId
		2, // nMulticastPortId
		"color", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_3_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_3_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_distance,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_3_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_camera,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_3_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_wheel,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_3_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_led,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_3_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_3_color,
...
SMulticastGroup g_astMulticastGroups[] = {
	...
	{
		26, // Multicast group ID
		"Burger_3_distance", // pszGroupName
		MULTICAST_Burger_3_distance_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_3_distance, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_Burger_3_distance, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_3_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		27, // Multicast group ID
		"Burger_3_camera", // pszGroupName
		MULTICAST_Burger_3_camera_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_3_camera, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_Burger_3_camera, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_3_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		25, // Multicast group ID
		"Burger_3_wheel", // pszGroupName
		MULTICAST_Burger_3_wheel_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_3_wheel, // pstInputPort
		1, // nInputPortNum
		g_astMulticastOutputPortList_Burger_3_wheel, // pstOutputPort
		3, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_3_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		28, // Multicast group ID
		"Burger_3_led", // pszGroupName
		MULTICAST_Burger_3_led_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_3_led, // pstInputPort
		1, // nInputPortNum
		g_astMulticastOutputPortList_Burger_3_led, // pstOutputPort
		2, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_3_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		24, // Multicast group ID
		"Burger_3_color", // pszGroupName
		MULTICAST_Burger_3_color_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_3_color, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_Burger_3_color, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_3_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
