...
SSerialChannel g_stSerialChannel_30 = {
	&g_astSerialSlaveInfo[0],
	{
		MESSAGE_TYPE_NONE,
		0,
	},
	&g_stSharedMemoryChannel_30,
};

SSharedMemoryChannel g_stSharedMemoryChannel_31 = {
...
SSerialChannel g_stSerialChannel_31 = {
	&g_astSerialSlaveInfo[0],
	{
		MESSAGE_TYPE_NONE,
		0,
	},
	&g_stSharedMemoryChannel_31,
};
...
SSerialChannel g_stSerialChannel_32 = {
	&g_astSerialSlaveInfo[0],
	{
		MESSAGE_TYPE_NONE,
		0,
	},
	&g_stSharedMemoryChannel_32,
};
...
SChannel g_astChannels[] = {
	{
		...
		&g_stSerialChannel_30, // specific serial channel structure pointer
	},
	{
		31, // Channel ID
		-1, // Next channel index (which is used for single port is connecting to multiple channels)
		...
		0, // Initial data length
		&g_stSerialChannel_31, // specific serial channel structure pointer
	},
	{
		32, // Channel ID
		-1, // Next channel index (which is used for single port is connecting to multiple channels)
		...
		0, // Initial data length
		&g_stSerialChannel_32, // specific serial channel structure pointer
	},
};
