...
#define TASK_NAME "Burger_6_color_O_color"
#define THIS_TASK_ID (126)
...
#define TASK_INIT void Burger_6_color_O_color_Init0(int TASK_ID)
#define TASK_GO void Burger_6_color_O_color_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_6_color_O_color_Wrapup0()
