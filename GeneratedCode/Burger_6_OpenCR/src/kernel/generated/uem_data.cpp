...
void Burger_6_led_O_led_Init0(int nTaskId);
void Burger_6_led_O_led_Go0(int nTaskId);
void Burger_6_led_O_led_Wrapup0();


void Burger_6_wheel_O_wheelControl_Init0(int nTaskId);
void Burger_6_wheel_O_wheelControl_Go0(int nTaskId);
void Burger_6_wheel_O_wheelControl_Wrapup0();




void Burger_6_color_O_color_Init0(int nTaskId);
void Burger_6_color_O_color_Go0(int nTaskId);
void Burger_6_color_O_color_Wrapup0();
...
STask g_astTasks_Burger_6_wheel[] = {
	{ 	124, // Task ID
		"Burger_6_wheel_O_wheelControl", // Task name
		TASK_TYPE_COMPUTATIONAL, // Task Type
		{
			Burger_6_wheel_O_wheelControl_Init0, // Task init function
			Burger_6_wheel_O_wheelControl_Go0, // Task go function
			Burger_6_wheel_O_wheelControl_Wrapup0, // Task wrapup function
		}, // Task function array
...
STask g_astTasks_Burger_6_color[] = {
	{ 	126, // Task ID
		"Burger_6_color_O_color", // Task name
		TASK_TYPE_COMPUTATIONAL, // Task Type
		{
			Burger_6_color_O_color_Init0, // Task init function
			Burger_6_color_O_color_Go0, // Task go function
			Burger_6_color_O_color_Wrapup0, // Task wrapup function
		}, // Task function array
		RUN_CONDITION_TIME_DRIVEN, // Run condition
		50, // Period
		TIME_METRIC_MILLISEC, // Period metric
...
STask g_astTasks_Burger_6_led[] = {
	{ 	132, // Task ID
		"Burger_6_led_O_led", // Task name
		TASK_TYPE_COMPUTATIONAL, // Task Type
		{
			Burger_6_led_O_led_Init0, // Task init function
			Burger_6_led_O_led_Go0, // Task go function
			Burger_6_led_O_led_Wrapup0, // Task wrapup function
		}, // Task function array
		RUN_CONDITION_DATA_DRIVEN, // Run condition
		50, // Period
		TIME_METRIC_MILLISEC, // Period metric
