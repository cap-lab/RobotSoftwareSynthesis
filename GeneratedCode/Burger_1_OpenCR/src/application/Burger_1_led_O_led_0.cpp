...
#define TASK_NAME "Burger_1_led_O_led"
#define THIS_TASK_ID (20)
...
#define TASK_INIT void Burger_1_led_O_led_Init0(int TASK_ID)
#define TASK_GO void Burger_1_led_O_led_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_1_led_O_led_Wrapup0()
