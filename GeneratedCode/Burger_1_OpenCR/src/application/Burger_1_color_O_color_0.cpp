...
#define TASK_NAME "Burger_1_color_O_color"
#define THIS_TASK_ID (11)
...
#define TASK_INIT void Burger_1_color_O_color_Init0(int TASK_ID)
#define TASK_GO void Burger_1_color_O_color_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_1_color_O_color_Wrapup0()
