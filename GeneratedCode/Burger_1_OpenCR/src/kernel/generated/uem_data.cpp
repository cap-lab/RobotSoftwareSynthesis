...
void Burger_1_led_O_led_Init0(int nTaskId);
void Burger_1_led_O_led_Go0(int nTaskId);
void Burger_1_led_O_led_Wrapup0();

void Burger_1_wheel_O_wheelControl_Init0(int nTaskId);
void Burger_1_wheel_O_wheelControl_Go0(int nTaskId);
void Burger_1_wheel_O_wheelControl_Wrapup0();




void Burger_1_color_O_color_Init0(int nTaskId);
void Burger_1_color_O_color_Go0(int nTaskId);
void Burger_1_color_O_color_Wrapup0();
...
STask g_astTasks_Burger_1_led[] = {
	{ 	20, // Task ID
		"Burger_1_led_O_led", // Task name
		TASK_TYPE_COMPUTATIONAL, // Task Type
		{
			Burger_1_led_O_led_Init0, // Task init function
			Burger_1_led_O_led_Go0, // Task go function
			Burger_1_led_O_led_Wrapup0, // Task wrapup function
		}, // Task function array
...
STask g_astTasks_Burger_1_color[] = {
	{ 	11, // Task ID
		"Burger_1_color_O_color", // Task name
		TASK_TYPE_COMPUTATIONAL, // Task Type
		{
			Burger_1_color_O_color_Init0, // Task init function
			Burger_1_color_O_color_Go0, // Task go function
			Burger_1_color_O_color_Wrapup0, // Task wrapup function
		}, // Task function array
		RUN_CONDITION_TIME_DRIVEN, // Run condition
		50, // Period
		TIME_METRIC_MILLISEC, // Period metric
...
STask g_astTasks_Burger_1_wheel[] = {
	{ 	15, // Task ID
		"Burger_1_wheel_O_wheelControl", // Task name
		TASK_TYPE_COMPUTATIONAL, // Task Type
		{
			Burger_1_wheel_O_wheelControl_Init0, // Task init function
			Burger_1_wheel_O_wheelControl_Go0, // Task go function
			Burger_1_wheel_O_wheelControl_Wrapup0, // Task wrapup function
		}, // Task function array
		RUN_CONDITION_DATA_DRIVEN, // Run condition
		50, // Period
		TIME_METRIC_MILLISEC, // Period metric
