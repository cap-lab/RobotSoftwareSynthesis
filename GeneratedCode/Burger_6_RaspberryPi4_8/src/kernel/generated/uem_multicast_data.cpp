...
char s_pMulticastGroup_Burger_6_camera_buffer[MULTICAST_Burger_6_camera_SIZE];
...
char s_pMulticastGroup_Burger_6_distance_buffer[MULTICAST_Burger_6_distance_SIZE];
char s_pMulticastGroup_Robot_leader_robotId_buffer[MULTICAST_Robot_leader_robotId_SIZE];
char s_pMulticastGroup_Burger_6_wheel_buffer[MULTICAST_Burger_6_wheel_SIZE];
char s_pMulticastGroup_Robot_groupA_leader_heartbeat_buffer[MULTICAST_Robot_groupA_leader_heartbeat_SIZE];
char s_pMulticastGroup_Burger_6_color_buffer[MULTICAST_Burger_6_color_SIZE];
char s_pMulticastGroup_Burger_6_led_buffer[MULTICAST_Burger_6_led_SIZE];
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_6_camera = {
	s_pMulticastGroup_Burger_6_camera_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_6_distance = {
	s_pMulticastGroup_Burger_6_distance_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_6_wheel = {
	s_pMulticastGroup_Burger_6_wheel_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_6_color = {
	s_pMulticastGroup_Burger_6_color_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
SSharedMemoryMulticast g_stSharedMemoryMulticast_Burger_6_led = {
	s_pMulticastGroup_Burger_6_led_buffer, // pData
	0, // nDataLen
	(HThreadMutex) NULL, // Mutex
};
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_6_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_camera,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_6_camera[] = {
	{
		120, // nTaskId
		0, // nPortId
		"camera", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_6_camera, // astCommunicationList
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_6_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_distance,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_6_distance[] = {
	{
		119, // nTaskId
		0, // nPortId
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_6_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		115, // nTaskId
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_6_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_wheel,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_6_wheel[] = {
	{
		123, // nTaskId
		0, // nPortId
		"wheel", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_6_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_6_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_color,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_6_color[] = {
	{
		119, // nTaskId
		0, // nPortId
		"color", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_6_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		115, // nTaskId
...
SMulticastCommunication g_astMulticastInputCommunicationList_Burger_6_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_led,
	},
};

SMulticastPort g_astMulticastInputPortList_Burger_6_led[] = {
	{
		131, // nTaskId
		0, // nPortId
		"led", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastInputCommunicationList_Burger_6_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_6_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_camera,
...
SMulticastPort g_astMulticastOutputPortList_Burger_6_camera[] = {
	{
		130, // nTaskId
		2, // nMulticastPortId
		"camera", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_6_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_6_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_distance,
...
SMulticastPort g_astMulticastOutputPortList_Burger_6_distance[] = {
	{
		129, // nTaskId
		2, // nMulticastPortId
		"distance", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_6_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_6_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_wheel,
...
SMulticastPort g_astMulticastOutputPortList_Burger_6_wheel[] = {
	{
		119, // nTaskId
		1, // nMulticastPortId
		"wheel", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_6_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		112, // nTaskId
...
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_6_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_color,
...
SMulticastPort g_astMulticastOutputPortList_Burger_6_color[] = {
	{
		127, // nTaskId
		2, // nMulticastPortId
		"color", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_6_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
};
SMulticastCommunication g_astMulticastOutputCommunicationList_Burger_6_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_led,
...
SMulticastPort g_astMulticastOutputPortList_Burger_6_led[] = {
	{
		121, // nTaskId
		1, // nMulticastPortId
		"led", // pszPortName
		...
		&g_stMulticastHostMemory, // pstMemoryAccessAPI
		(SMulticastGroup *) NULL, // pMulticastGroup
		g_astMulticastOutputCommunicationList_Burger_6_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		117, // nTaskId
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_6_camera[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_camera,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_6_distance[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_distance,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_6_wheel[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_wheel,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_6_color[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_color,
...
SMulticastCommunication g_astMulticastCommunicationList_Burger_6_led[] = {
	{
		SHARED_MEMORY,
		&g_stSharedMemoryMulticast,
		&g_stSharedMemoryMulticast_Burger_6_led,
...
SMulticastGroup g_astMulticastGroups[] = {
	...
	{
		37, // Multicast group ID
		"Burger_6_camera", // pszGroupName
		MULTICAST_Burger_6_camera_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_6_camera, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_Burger_6_camera, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_6_camera, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		36, // Multicast group ID
		"Burger_6_distance", // pszGroupName
		MULTICAST_Burger_6_distance_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_6_distance, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_Burger_6_distance, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_6_distance, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		34, // Multicast group ID
		"Burger_6_wheel", // pszGroupName
		MULTICAST_Burger_6_wheel_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_6_wheel, // pstInputPort
		1, // nInputPortNum
		g_astMulticastOutputPortList_Burger_6_wheel, // pstOutputPort
		3, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_6_wheel, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
	...
	{
		35, // Multicast group ID
		"Burger_6_color", // pszGroupName
		MULTICAST_Burger_6_color_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_6_color, // pstInputPort
		2, // nInputPortNum
		g_astMulticastOutputPortList_Burger_6_color, // pstOutputPort
		1, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_6_color, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
		38, // Multicast group ID
		"Burger_6_led", // pszGroupName
		MULTICAST_Burger_6_led_SIZE, // Multicast group buffer size
		g_astMulticastInputPortList_Burger_6_led, // pstInputPort
		1, // nInputPortNum
		g_astMulticastOutputPortList_Burger_6_led, // pstOutputPort
		2, // nOutputPortNum
		g_astMulticastCommunicationList_Burger_6_led, // astCommunicationList
		1, // nCommunicationTypeNum
	},
	{
