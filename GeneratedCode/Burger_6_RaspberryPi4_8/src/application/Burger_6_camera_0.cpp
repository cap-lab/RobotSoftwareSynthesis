...
#define TASK_NAME "Burger_6_camera"
#define THIS_TASK_ID (130)
...
#define TASK_INIT void Burger_6_camera_Init0(int TASK_ID)
#define TASK_GO void Burger_6_camera_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_6_camera_Wrapup0()
