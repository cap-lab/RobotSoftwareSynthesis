...
#define TASK_NAME "Burger_6_GA_DTA"
#define THIS_TASK_ID (134)
...
#define LIBCALL_group(f, ...) l_Burger_6_grouping_##f(__VA_ARGS__)
#include "Burger_6_grouping.cicl.h"
#define SYS_REQ(x, ...) SYS_REQ_##x(THIS_TASK_ID, ## __VA_ARGS__)

#define TASK_INIT void Burger_6_GA_DTA_Init0(int TASK_ID)
#define TASK_GO void Burger_6_GA_DTA_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_6_GA_DTA_Wrapup0()
