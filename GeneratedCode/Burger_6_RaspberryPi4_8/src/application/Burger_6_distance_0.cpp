...
#define TASK_NAME "Burger_6_distance"
#define THIS_TASK_ID (129)
...
#define TASK_INIT void Burger_6_distance_Init0(int TASK_ID)
#define TASK_GO void Burger_6_distance_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_6_distance_Wrapup0()
