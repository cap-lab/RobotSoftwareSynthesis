...
#define TASK_NAME "Burger_6_leader"
#define THIS_TASK_ID (135)
...
#define TASK_INIT void Burger_6_leader_Init0(int TASK_ID)
#define TASK_GO void Burger_6_leader_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_6_leader_Wrapup0()
