...
#define TASK_NAME "Burger_6_wheel_R_getDirection"
#define THIS_TASK_ID (123)
...
#define TASK_INIT void Burger_6_wheel_R_getDirection_Init0(int TASK_ID)
#define TASK_GO void Burger_6_wheel_R_getDirection_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_6_wheel_R_getDirection_Wrapup0()
