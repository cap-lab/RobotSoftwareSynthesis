...
#define TASK_NAME "Burger_6_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3_R_controlAndReport"
#define THIS_TASK_ID (119)
...
#define LIBCALL_searchedColor(f, ...) l_Burger_6_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_searchV3_0_##f(__VA_ARGS__)
...
#define TASK_INIT void Burger_6_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3_R_controlAndReport_Init0(int TASK_ID)
#define TASK_GO void Burger_6_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3_R_controlAndReport_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_6_Robot_groupB_SEARCHIN_MODE_SEARCHIN_Search_Burger_searchV3_R_controlAndReport_Wrapup0()
