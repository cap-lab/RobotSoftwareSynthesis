...
#define TASK_NAME "Burger_6_listen"
#define THIS_TASK_ID (136)
...
#define TASK_INIT void Burger_6_listen_Init0(int TASK_ID)
#define TASK_GO void Burger_6_listen_Go0(int nTaskId)
#define TASK_WRAPUP void Burger_6_listen_Wrapup0()
